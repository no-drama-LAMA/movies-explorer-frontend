            ...
            <nav className="header__burger-nav">
              <ul className="header__burger-list">
                <li className="header__burger-item">
                  ...
                  <NavLink to='/' className={`header__link header__link_burger ${pathname === "/" ? "header__link_active" : ""}`}>
                    Главная
                  </NavLink>
                </li>
                <li className="header__burger-item">
                  <NavLink to='/movies' className={`header__link header__link_burger ${pathname === "/movies" ? "header__link_active" : ""}`}>
                    Фильмы
                  </NavLink>
                </li>
                <li className="header__burger-item">
                  <NavLink to='/saved-movies' className={`header__link header__link_burger ${pathname === "/saved-movies" ? "header__link_active" : ""}`}>
                    Сохранённые фильмы
                  </NavLink>
                </li>
                <li className="header__burger-item">
                  <NavLink to='/movies' className={`header__link header__link_burger header__link_profile ${pathname === "/profile" ? "header__link_active" : ""}`}>
                    Аккаунт
